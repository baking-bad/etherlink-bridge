# Setup used to run jupyter notebook scenarios and to simplify interaction with
# contracts, all useful functions are imported (even if they would not be used):
# ruff: noqa: F401
...
def load_contracts(
    ...
    TokenHelper, Ticketer, Erc20ProxyHelper, TokenBridgeHelper, TicketRouterTester
]:
