...
> Run `poetry run bridge_token --help` for information about these parameters.
...
> Run `poetry run deposit --help` for information about these parameters.
k
...
> NOTE: Withdrawal required to be finalized on Tezos side after commitment with witdhrawal has been settled. See more here: [Withdrawal process](docs/README.md#withdrawal-process).
